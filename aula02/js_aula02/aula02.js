...
console.log(animal1.habitat[0]);
console.log(animal1.getEspecie);
let animal2 = new Animal("Felis silvestris catus", "Gato", 1.5, ["Jardim", "Floresta"]);
console.log(animal2);
...
let professor1 = new Professor("Oliota", 33, ["java", "html", "javascript"], 90, 400);
...
let vendedor1 = new Vendedor("thabata", 28, 50, 5000);
